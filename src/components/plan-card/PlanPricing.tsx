        ...
        {prices.map((item) => (
          <div 
            ...
            className={`
              ...
              ${item.id === estimatedUse ? 'bg-primary/10 border border-primary' : 'hover:bg-gray-50'}
            `}
          >
            <span className="text-sm text-gray-600">{item.kwh}</span>
            <div className="flex items-baseline gap-1">
              <span className={`text-lg font-medium ${item.id === estimatedUse ? 'text-primary' : 'text-gray-700'}`}>
